...
from .adversarial_foolbox import AdversarialFoolbox
...
class CarliniWagnerL2AttackRoundFFT(CarliniWagnerL2Attack):
    ...
    def init_roundfft_adversarial(self, original_image, original_class):
        ...
        self.adaptive_adversarial = AdversarialFoolbox(
    ...
    def get_roundfft_adversarial(self):
        ...
        """
        return self.adaptive_adversarial.image
    ...
    def __call__(self, input_or_adv, label=None, unpack=True,
                 binary_search_steps=1, max_iterations=1000, confidence=0,
        ...
        for binary_search_step in range(binary_search_steps):
            ...
            for iteration in range(max_iterations):
                ...
                if self.args.noise_iterations > 0:
                    ...
                    in_bounds = self.adaptive_adversarial.in_bounds(x)
                    ...
                    original_class = self.adaptive_adversarial.original_class
                    if result_noise.class_id != original_class:
                        is_adv = True
                        self.adaptive_adversarial._Adversarial__new_adversarial(
                    ...
                    _, is_adv = self.adaptive_adversarial.predictionsRoundFFT(
